        ...
        <div class="modal">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="modal-live-url" class="form-control">
                    <span class="error-message" id="error-modal-live-url"></span>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('modal-save-btn').addEventListener('click', function () {
            ...
            Object.keys(fields).forEach(key => {
                ...
                if ((key === 'url' || key === 'live_url') && value && !urlRegex.test(value)) {
            ...
            fetch('api/add-website.php', {
                ...
                .then(response => {
                    ...
                    if (response.status === 'success') {
                        ...
                        showMessage(response.message, true, 'dblist.php', 4000);
                        ...
                        showMessage(response.message, false, 'dblist.php', 5000);
                    }
                })
                .catch(err => {
